...
$sql_filtered = "SELECT meal_date, meal_type, price FROM meal_bookings WHERE user_id = ?";
...
<div><?php include 'navbar.php'; ?></div>
    <div class="container">
        ...
        <h3>Filtered Total Price: $<?php echo number_format($filtered_price, 2); ?></h3>
        <button class="btn btn-primary " onclick="toggleTable()">Show History</button>
